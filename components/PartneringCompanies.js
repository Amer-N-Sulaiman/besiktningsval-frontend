...
const PartneringCompanies = ()=>{
	...
	return <div className="PartneringCompanies" style={{width: '90%', margin: '20px auto', backgroundColor: 'white'}}>
		...
		<Container>
			...
			<Row>
				<Col>
					<img src='/companiesLogos/Carspect-logo.png' alt='Carspect logo' height='100px' width='100px' style={{/*height: '100px'*/}} />
				</Col>
				<Col>
					<img src='/companiesLogos/Opus-logo.png' alt='Opus logo' height='100px' width='100px' style={{/*height: '100px'*/}} />
				</Col>
				<Col style={{paddingTop: '37px', paddingBottom: '37px'}}>
					<img height='27px' width='100px' alt='Dekra logo' src='/companiesLogos/Dekra-logo.png' style={{/*width: '100px',*/ }} />
				</Col>
			</Row>
		</Container>
		</Card>
